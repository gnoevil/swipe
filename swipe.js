...
$('.swipe-wrap > div').on('scroll, touchmove', function() {
// get the current scroll position
scrollTop = $(this).scrollTop();
// make sure the cover container is still visible
//   if (scrollTop > winHeight * 0.9) return;
if ((winHeight - scrollTop) / winHeight * 1.25 < 0) return;
// adjust the cover image
$(this).find('.cover-image').not('footer').css({
height: winHeight * 0.9 - scrollTop +'px',
marginTop: scrollTop +'px',
opacity: (winHeight - scrollTop) / winHeight * 1.125
})
$('.position').text(winHeight - scrollTop +'px ~ '+ (winHeight - scrollTop) / winHeight * 0.9 * 100 +'%')
})
}
